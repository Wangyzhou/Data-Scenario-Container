              ...
              <el-card :body-style="{ padding: '0px' }">
                ...
                <div class="sceneInfo">
                  ...
                  <div class="scene-type">
                    <svg class="icon" aria-hidden="true">
                      <use xlink:href="#icon-earth_"></use>
                    </svg>&nbsp;&nbsp;
                ...
                <div class="scene-bottom">
                  <div>
                    ...
                    <time class="time">{{ userStore.loginUser.username }}</time>
                  </div>
...
const createScene = () => {
  router.push('/home/scene/createScene')
}
const flushSceneList = () => {
  sceneApi.getSceneList(userStore.loginUser.id).then(res => {
    console.log(res)
...
const enterScene = (scene: Scene) => {
  ...
  router.push('/home/mapDataSceneEditor/' + scene.sceneId)
}
