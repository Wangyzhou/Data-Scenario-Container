<template>
  <div class="allcontainer">
          ...
          <el-menu-item index="1">
            <el-icon>
              <svg class="icon" aria-hidden="true">
                <use xlink:href="#icon-layergroup-fill"></use>
              </svg>
            </el-icon>
            <template #title>
              图层
    ...
    <ToolPannel v-if="activatedMenu === '2' && sceneStore.editingScene.sceneType === 'analysis'"
      :menu-width="isCollapse ? '65px' : '113px'" @close-tool-pannel="activatedMenu = '0'" :tool-lab="toolLab"
      @render:scene-layer-group="renderSceneLayerGroup"></ToolPannel>
...
import SingleValueRender from '~/assets/VisualizationTemplateCode/SingleValueRender'
import UniqueValueRender from '~/assets/VisualizationTemplateCode/UniqueValueRender'
// import UniqueValueRender from 'http://localhost:8998/js/UniqueValueRender.js'
import HierarchicalRender from '~/assets/VisualizationTemplateCode/HierarchicalRender'
import GradualValueRender from '~/assets/VisualizationTemplateCode/GradualValueRender'
